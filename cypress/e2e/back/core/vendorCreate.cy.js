...
const url = "http://192.168.1.18:8082/vendors";

describe('Validating qualification functionality - Scenarios positives and negatives', () => {
    ;[
        { scenario: 'Sending Vendor create method', method: 'POST', useAuthentication: false, url: url, requestWithParam: false, sendingdata: bodyVendorCreate, expectedStatusCode: 201, assertResponse: expectSuccessOperation },
