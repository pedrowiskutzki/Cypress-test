...
const url = "http://192.168.1.18:8082/suppliers";

describe('Validating qualification functionality - Scenarios positives and negatives', () => {
    ;[
        { scenario: 'Sending Vendor create method', method: 'POST', useAuthentication: false, url: url, requestWithParam: false, sendingdata: bodySupplierCreate, expectedStatusCode: 201, assertResponse: expectSuccessOperation },
